            ...
            <div className="pt-11">
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-6 text-white">
                    ...
                    {/* <div className="panel bg-gradient-to-r from-violet-500 to-violet-400">
                        <div className="flex justify-between">
                            <div className="ltr:mr-1 rtl:ml-1 text-md font-semibold"> Total Orders</div>
                        </div>
                        <div className="flex items-center mt-5">
                    ...
                    <div className="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
                        <div className="flex justify-between">
                            <div className="ltr:mr-1 rtl:ml-1 text-md font-semibold"> Orders on Hold</div>
                        </div>
                        <div className="flex items-center mt-5">
                    ...
                    <div className="panel bg-gradient-to-r from-blue-500 to-blue-400">
                        <div className="flex justify-between">
                            <div className="ltr:mr-1 rtl:ml-1 text-md font-semibold"> Loan Approval Statistics</div>
                        </div>
                        <div className="flex items-center mt-5">
