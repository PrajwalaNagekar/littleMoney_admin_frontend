...
const columns = [
    {
        ...
        render: (row: any, index: number) => {
            const pageSize = 10; // Adjust according to your pagination settings
            const currentPage = 1; // Get the current page dynamically from your DataTableComponent
    ...
    { accessor: 'ifsc', title: 'IFSC', sortable: true },
]
