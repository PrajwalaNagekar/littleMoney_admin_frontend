...
const OtpVerification = () => {
    ...
    const formik = useFormik<FormValues>({
        ...
        onSubmit:async (values) => {
            ...
            const { contactNo } = values; // Assuming contactNo is part of the form values
        
            try {
                // Call the verifyOtp API with the contact number and OTP from the form
                const response = await verifyOtp({ contactNo, otp });
        
                if (response.success) {
                    // Determine the user type based on the contact number (or based on some other logic you may have)
                        ...
                        // If contact number doesn't match the predefined ones, handle accordingly
